...
INSERT INTO "new_Document" ("author_id", "deleted", "existing", "file_data", "filename", "id", "is_template", "title", "zoho_document_id") SELECT "author_id", "deleted", "existing", "file_data", "filename", "id", "is_template", "title", "zoho_document_id" FROM "Document";
DROP TABLE "Document";
