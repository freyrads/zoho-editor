...
CREATE TABLE "new_ZohoSession" (
    ...
    CONSTRAINT "ZohoSession_joined_session_id_fkey" FOREIGN KEY ("joined_session_id") REFERENCES "ZohoSession" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_ZohoSession" ("deleted", "document_id", "id", "session_data", "session_id", "session_type", "user_id", "zoho_document_id") SELECT "deleted", "document_id", "id", "session_data", "session_id", "session_type", "user_id", "zoho_document_id" FROM "ZohoSession";
